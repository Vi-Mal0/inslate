...
class _BucketState extends State<Bucket> {
        ...
        return Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                RatingBar.builder(
                  initialRating: data.quants == null ?1 :double.parse(data.quants["logicalReasoning"].toString()),
                  minRating: 1,
                  direction: Axis.horizontal,
                  itemCount: 5,
                  itemBuilder: (context, _) => const Icon(
            ...
            Row(
              ...
              children: [
                RatingBar.builder(
                  initialRating:data.quants == null ? 1:double.parse(data.quants["verbalAbility"].toString()),
                  minRating: 1,
                  direction: Axis.horizontal,
                  itemCount: 5,
                  itemBuilder: (context, _) => const Icon(
            ...
            Row(
              ...
              children: [
                RatingBar.builder(
                  initialRating: data.quants == null ? 1: double.parse(data.quants["codingAndDecoding"].toString()),
                  minRating: 1,
                  direction: Axis.horizontal,
                  itemCount: 5,
                  itemBuilder: (context, _) => const Icon(
  ...
  getData(){
    http.getEmployeeByID(widget.id.toString()).then((value) {
      setState(() {
        employee = value;
      });
    });
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Container(
        ...
        //     itemCount: employee.assignedCandidates?.length,
        //     padding: const EdgeInsets.only(top: 0.0),
        //     itemBuilder: (context, index) {
        //
        //       e= employee.assignedCandidates;
        //
        //       retColor(){
        //         var clr =e[index].currentStatus;
        ...
        //                   child: Row(
        //                     children: [
        //                       Container(width: 210,child: Text("email : ${e[index].email}",)),
        //                       SizedBox(width: 50,),
        //                       Text("Phone : ${e[index].mobileNumber}"),
        //                     ],
        //                   ),
        //                 ),
        //                 Padding(
        ...
        //                   child: Row(
        //                     children: [
        //                       Text("Qualification : ${e[index].highestQualification}"),
        //                     ],
        //                   ),
        //                 ),
        //                 Padding(
        ...
        //                   child: Row(
        //                     children: [
        //                       Text("Interview Schedule : ${e[index].availableDateAndTime}"),
        //                     ],
        //                   ),
        //                 ),
        //               ],
                    ...
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: (){
                                _openBottomSheet(snapshot.data.assignedCandidates[index]);
