  ...
  _openBottomSheet(data){
    return showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        ...
        return Stack(
          children:[
            Positioned(right: 10,top: 5,child: IconButton(onPressed: (){}, icon: const Icon(Icons.clear))),
            Column(
        ...
        child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if(snapshot.hasData){
                                ...
                                child: Card(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            SizedBox(width: 210,child: Text("email : ${snapshot.data.assignedCandidates[index].email}",)),
                ...
                return const Center(
                  child: CircularProgressIndicator(color:Color(0xffbe61565) ,),
                );
              }
            },
          ),
